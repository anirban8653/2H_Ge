...
params_coupling = {
    ...
    "A_c2_perp": 3.1579 * hbar**2 / (2 * m0)/(e*1e-20),
    "A_c1_perp": 9.5120 * hbar**2 / (2 * m0)/(e*1e-20),
    "A_c2_parallel": 3.3348 * hbar**2 / (2 * m0)/(e*1e-20),
    "A_c1_parallel": 1 * hbar**2 / (2 * m0)/(e*1e-20),
    "A_1": -5.4167 * hbar**2 / (2 * m0)/(e*1e-20),
    "A_2": -7.3684 * hbar**2 / (2 * m0)/(e*1e-20),
    "A_3": 3.3328 * hbar**2 / (2 * m0)/(e*1e-20),
    "A_4": 5.5263 * hbar**2 / (2 * m0)/(e*1e-20),
    "A_5": -0.2631 * hbar**2 / (2 * m0)/(e*1e-20),
    "A_6": -0.5415 * hbar**2 / (2 * m0)/(e*1e-20),
    "Delta_1": 0.2688 ,
    "Delta_2": 0.0934 ,
    "Delta_3": 0.0908 ,
    "Ecbp1": 0.632 ,
...
# ---------- Hamiltonian builder ----------
def Hfull(kx, ky, kz, p=params_coupling):
    k_plus = kx + 1j*ky
    k_minus = kx - 1j*ky
